...
use Entity\Operation\IdentifiableInterface;
use Workflower\Workflow\Activity\ActivityInterface;
use Workflower\Workflow\Activity\UnexpectedActivityException;
use Workflower\Workflow\Connection\SequenceFlow;
use Workflower\Workflow\Element\ConditionalInterface;
use Workflower\Workflow\Element\ConnectingObjectCollection;
use Workflower\Workflow\Element\ConnectingObjectInterface;
use Workflower\Workflow\Element\FlowObjectCollection;
...
use Workflower\Workflow\Gateway\GatewayInterface;
use Workflower\Workflow\Operation\OperationalInterface;
use Workflower\Workflow\Operation\OperationRunnerInterface;
use Workflower\Workflow\Participant\ParticipantInterface;
use Workflower\Workflow\Participant\Role;
use Workflower\Workflow\Participant\RoleCollection;
